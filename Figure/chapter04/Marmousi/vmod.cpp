...
int main(int  argc,char **argv)
{
        ...
        fp3=fopen("nx500nz280dxdz12.5.vp","rb");
        fp4=fopen("nx500nz280dxdz12.5.vs","rb");
        fp5=fopen("nx500nz280dxdz12.5.smooth10.vp","wb");
        fp6=fopen("nx500nz280dxdz12.5.smooth10.vs","wb");
        for(i=0;i<nx;i++)
        {
