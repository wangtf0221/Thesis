...
将声波FWI扩展到弹性介质中学要付出更多的工作。
当$V_p$，$V_s$和$\rho$在结构上有差异时，trade-off效应会更加明显。
很多学者指出参数化方式对缓解trade-off效应非常重要，通过调查散射模式或者Hessian算子来选取恰当的参数化方式
\cite[]{wu.aki:1985,tarantola:1986,plessix.cao:2011,gholami2013}。另外一个常用的降低非线性程度的方法是采用多尺度的策略
将速度扰动分解为低波数与高波数成分，然后利用不同的数据子集或者在不同阶段进行反演\cite[]{symes.carazzone:1991,bunks1995multiscale,clement:2001,shin.cha:2008,dehoop:2012,
xu:2012,biondi.almomin:2013,ma2013,warner2016adaptive,alkhalifah2015scattering}。
正如Tarantola(1986)\cite{tarantola:1986}所建议的，我们应当先重构出对数据具有主要影响
