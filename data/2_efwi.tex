...
质非常有必要。相比于从地震偏移获得的定性化的成像剖面，人们更希望得到定量化的深度域弹
...
不同参数的偏导数波场在特定角度范围内的重叠导致的。因此，Wang et al (2015)\cite{wang:2015}提出了通过解耦弹性波波场并在不同阶段分别选取P波与S波
...
在图\ref{fig:all}中，同样采用前文小模型实验来比较PCG、GN和MDPCG方法的梯度。
