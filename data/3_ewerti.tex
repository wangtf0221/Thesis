...
\begin{figure}
   \centering
   \subfloat[]{\includegraphics[width=0.30\textwidth]{Figure/chapter03/Kernel/1vp.pdf}}
   \subfloat[]{\includegraphics[width=0.30\textwidth]{Figure/chapter03/Kernel/1vs.pdf}}\\
   \subfloat[]{\includegraphics[width=0.30\textwidth]{Figure/chapter03/Kernel/Vponlyvp.pdf}}
   \subfloat[]{\includegraphics[width=0.30\textwidth]{Figure/chapter03/Kernel/Vsonlyvp.pdf}}\\
...
\begin{figure}
   \centering
   \subfloat[]{\includegraphics[width=0.30\textwidth]{Figure/chapter03/Kernel/2vp.pdf}}
   \subfloat[]{\includegraphics[width=0.30\textwidth]{Figure/chapter03/Kernel/2vs.pdf}}\\
...
\begin{figure}
   \centering
   \subfloat[]{\includegraphics[width=0.30\textwidth]{Figure/chapter03/Kernel/VsonlyvsPP.pdf}}
   \subfloat[]{\includegraphics[width=0.30\textwidth]{Figure/chapter03/Kernel/VsonlyvsPS.pdf}}\\
   \subfloat[]{\includegraphics[width=0.30\textwidth]{Figure/chapter03/Kernel/VsonlyvsSP.pdf}}
   \subfloat[]{\includegraphics[width=0.30\textwidth]{Figure/chapter03/Kernel/VsonlyvsSS.pdf}}
...
\begin{figure}
   \centering
   \subfloat[]{\includegraphics[width=0.48\textwidth]{Figure/chapter03/DIW_L2/1layer.pdf}}
   \subfloat[]{\includegraphics[width=0.48\textwidth]{Figure/chapter03/DIW_L2/1layerL2.pdf}}\\
   \subfloat[]{\includegraphics[width=0.48\textwidth]{Figure/chapter03/DIW_L2/3layer.pdf}}
   \subfloat[]{\includegraphics[width=0.48\textwidth]{Figure/chapter03/DIW_L2/3layerL2.pdf}}\\
   \subfloat[]{\includegraphics[width=0.48\textwidth]{Figure/chapter03/DIW_L2/Sigsbee.pdf}}
   \subfloat[]{\includegraphics[width=0.48\textwidth]{Figure/chapter03/DIW_L2/complexL2.pdf}}
...
\begin{figure}[!htb]
   \centering
   \subfloat[]{\includegraphics[width=0.48\textwidth]{Figure/chapter03/sigbee2/LSF_Gra_vp.pdf}}
   \subfloat[]{\includegraphics[width=0.48\textwidth]{Figure/chapter03/sigbee2/NoLSF_Gra_vp.pdf}}\\
   \subfloat[]{\includegraphics[width=0.48\textwidth]{Figure/chapter03/sigbee2/Fig/newinit3vp.pdf}}
