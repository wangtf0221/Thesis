...
%        \subfigure{\includegraphics[width=5cm]{radiationpattern/Fig/PP.pdf}}
...
\begin{figure*}
    \begin{center}
        \subfloat(a){\includegraphics[width=7cm]{smallmodel/Fig/truevp.pdf}}
        \subfloat(b){\includegraphics[width=7cm]{smallmodel/Fig/truevs.pdf}}
        \subfloat(c){\includegraphics[width=7cm]{smallmodel/Fig/nodecomvp.pdf}}
        \subfloat(d){\includegraphics[width=7cm]{smallmodel/Fig/nodecomvs.pdf}}
        \subfloat(e){\includegraphics[width=7cm]{smallmodel/Fig/decomvp.pdf}}
        \subfloat(f){\includegraphics[width=7cm]{smallmodel/Fig/decomvs.pdf}}
        \caption{
...
\begin{figure*}
    \begin{center}
        \subfloat(a){\includegraphics[width=9cm]{tariqsugresult/Fig/truevp.pdf}}
        \subfloat(b){\includegraphics[width=9cm]{tariqsugresult/Fig/truevs.pdf}}
        \subfloat(c){\includegraphics[width=9cm]{tariqsugresult/Fig/initvp.pdf}}
        \subfloat(d){\includegraphics[width=9cm]{tariqsugresult/Fig/initvs.pdf}}
        \caption{
...
\begin{figure*}
    \begin{center}
        \subfloat(a){\includegraphics[width=6cm]{tariqsugresult/Fig/nodevp.pdf}}
        \subfloat(b){\includegraphics[width=6cm]{tariqsugresult/Fig/nodevs.pdf}}
        \subfloat(c){\includegraphics[width=6cm]{tariqsugresult/Fig/devp.pdf}}
        \subfloat(d){\includegraphics[width=6cm]{tariqsugresult/Fig/devs.pdf}}
        \caption{
