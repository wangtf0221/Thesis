...
\begin{figure*}
    \begin{center}
        \subfloat(a){\includegraphics[width=5cm]{radiationpattern/Fig/PP.pdf}}
%        \subfloat{\includegraphics[width=5cm]{radiationpattern/Fig/PP.pdf}}
        \subfloat(b){\includegraphics[width=5cm]{radiationpattern/Fig/PS.pdf}}
        \subfloat(c){\includegraphics[width=5cm]{radiationpattern/Fig/SP.pdf}}
        \subfloat(d){\includegraphics[width=5cm]{radiationpattern/Fig/SS.pdf}}
...
\begin{figure}
    \begin{center}
		\subfloat[]{\includegraphics[width=5cm]{smallmodel/Fig/truevp.pdf}}
		\subfloat[]{\includegraphics[width=5cm]{smallmodel/Fig/truevs.pdf}}\\
		\subfloat[]{\includegraphics[width=5cm]{smallmodel/Fig/nodecomvp.pdf}}
		\subfloat[]{\includegraphics[width=5cm]{smallmodel/Fig/nodecomvs.pdf}}\\
		\subfloat[]{\includegraphics[width=5cm]{smallmodel/Fig/decomvp.pdf}}
		\subfloat[]{\includegraphics[width=5cm]{smallmodel/Fig/decomvs.pdf}}
        \caption{
...
\begin{figure}
    \begin{center}
		\subfloat[]{\includegraphics[width=7cm]{tariqsugresult/Fig/truevp.pdf}}
		\subfloat[]{\includegraphics[width=7cm]{tariqsugresult/Fig/truevs.pdf}}\\
		\subfloat[]{\includegraphics[width=7cm]{tariqsugresult/Fig/initvp.pdf}}
		\subfloat[]{\includegraphics[width=7cm]{tariqsugresult/Fig/initvs.pdf}}
        \caption{
...
\begin{figure}
    \begin{center}
		\subfloat[]{\includegraphics[width=7cm]{tariqsugresult/Fig/nodevp.pdf}}
		\subfloat[]{\includegraphics[width=7cm]{tariqsugresult/Fig/nodevs.pdf}}\\
		\subfloat[]{\includegraphics[width=7cm]{tariqsugresult/Fig/devp.pdf}}
		\subfloat[]{\includegraphics[width=7cm]{tariqsugresult/Fig/devs.pdf}}
        \caption{
...
\begin{figure*}
    \begin{center}
        \subfloat[]{\includegraphics[width=7cm]{tariqsugresult/Fig/truerho.pdf}}
        \subfloat[]{\includegraphics[width=7cm]{tariqsugresult/Fig/initrho.pdf}}
    \caption{
...
\begin{figure*}
    \begin{center}
        \subfloat[]{\includegraphics[width=7cm]{tariqsugresult/Fig/1nodevp.pdf}}
        \subfloat[]{\includegraphics[width=7cm]{tariqsugresult/Fig/1devp.pdf}}\\
        \subfloat[]{\includegraphics[width=7cm]{tariqsugresult/Fig/1nodevs.pdf}}
        \subfloat[]{\includegraphics[width=7cm]{tariqsugresult/Fig/1devs.pdf}}\\
        \subfloat[]{\includegraphics[width=7cm]{tariqsugresult/Fig/1noderho.pdf}}
        \subfloat[]{\includegraphics[width=7cm]{tariqsugresult/Fig/1derho.pdf}}
...
\begin{figure*}
    \begin{center}
        {\includegraphics[width=10cm]{tariqsugresult/Fig/3kmrho.pdf}}
        \caption{
...
\begin{figure*}
    \begin{center}
        {\includegraphics[width=10cm]{tariqsugresult/Fig/9kmrho.pdf}}
        \caption{
